...
<head>
	...
	<style type="text/css">
		#main {padding:0;margin:0;} #main .container-fluid{padding:0 6px 0 4px;}
		#header {margin:10px 0 10px;position:static;} #header li {font-size:16px;_font-size:14px;}
		#header .brand {font-family:Helvetica, Georgia, Arial, sans-serif, 黑体;font-size:40px;padding-left:33px;}
